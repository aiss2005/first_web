...
Hapus</button></a> 
                    ...
                    if($jumlahTemp > 0){ 
                    ?> 
                    <br /><a href="<?= base_url('peminjaman/simpan-transaksi-peminjaman');?>"><button class="btn 
...
target="_blank"><?php echo $data['e_book'];?></a></td> 
                            <td data-sortable="true"> 
                                ...
                                ?> 
                                <a href="<?= base_url('peminjaman/simpan-temp-pinjam')."/".sha1($data['id_buku']);?>"><button type="button" class="btn btn-primary">Pinjam 
Buku</button></a> 
                                <?php } else echo "#"; ?> 
                            </td> 
                        </tr> 
...
<script type="text/javascript"> 
    function doDelete(idDelete) { 
        ...
        .then(ok => { 
if (ok) { 
window.location.href = '<?= base_url() ?>/peminjaman/hapus-temp/' + idDelete; 
} else { 
