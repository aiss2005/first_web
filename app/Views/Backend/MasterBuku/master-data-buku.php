        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Master Data Buku
                        <a href="<?= base_url('buku/input-data-buku'); ?>"><button type="button" class="btn btn-sm btn-primary pull-right">Input Data Buku</button></a>
                    </h3>
                    <hr />
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-sortable="true">
                                    <?php if (!empty($data['cover_buku'])): ?>
                                        <img src="<?= base_url('Assets/CoverBuku/' . $data['cover_buku']); ?>" alt="Cover Buku" width="100"> 
                                        <?php?>
                                    <?php else: ?>
                                        (Tidak ada cover)
                                    <?php endif; ?>
                                ...
                                <td data-sortable="true">
                                    ...
                                    ?>
                                    <a href="<?= base_url('buku/edit-data-buku/') . sha1($data['id_buku']); ?>"><button type="button" class="btn btn-sm btn-success">Edit</button></a>
